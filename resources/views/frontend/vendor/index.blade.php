                                ...
                                <div class="col-md-5">
                                    <div class="form-group icon-start mb-20">
                                        ...
                                        <input type="text" name="name" value="{{ request()->input('name') }}"
                                            ...
                                            placeholder="{{ __('Vendor name/username') }}">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group icon-start mb-20">
...
>>>>>>> 99cdbae7c65aa3db6a5d6c5c45df65ec5649db25
                                ...
                                <div class="mt-10 pt-10 border-top text-center">
                                    @php
                                        $total_service = App\Models\Services\Services::where('vendor_id', 0)
                                            ->where('status', 1)
                                            ->count();
                                    @endphp
                                    <span class="font-sm">
                ...
                @foreach ($vendors as $vendor)
                    <div class="col-md-6 col-lg-4 col-xl-3" data-aos="fade-up">
                        <div class="card text-center border radius-md p-15 mb-25">
                            <figure class="card-img mx-auto mb-15">
                                <a href="{{ route('frontend.vendor.details', ['username' => $vendor->username]) }}"
                                    ...
                                    @if ($vendor->photo && file_exists(public_path('assets/admin/img/vendor-photo/' . $vendor->photo)))
                                        <img class="lazyload" src="{{ asset('assets/frontend/images/placeholder.png') }}"
                                            data-src="{{ asset('assets/admin/img/vendor-photo/' . $vendor->photo) }}"
                                            alt="{{ $vendor->username }}" loading="lazy"
                                            onerror="this.onerror=null;this.src='{{ asset('assets/img/user.png') }}'">
                                    @else
                                        <img class="lazyload" src="{{ asset('assets/frontend/images/placeholder.png') }}"
                                            data-src="{{ asset('assets/img/user.png') }}" alt="{{ $vendor->username }}"
                                            loading="lazy">
                                    @endif
                                </a>
                            </figure>
                            ...
                            <div class="ratings d-flex justify-content-center mt-2">
                                @php
                                    $reviews = App\Models\Services\ServiceReview::where(
                                        'vendor_id',
                                        $vendor->id,
                                    )->get();
                                    if ($reviews != '[]') {

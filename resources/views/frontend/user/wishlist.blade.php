                                                    ...
                                                    <tr class="item">
                                                        <td class="product">
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <div class="product-desc">
                                                                    <h6>
                                                                        <a class="product-title" target="_blank"
                                                                            title="Link"
                                                                            href="{{ route('frontend.service.details', ['slug' => $item->slug, 'id' => $item->service_id]) }}">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('frontend.service.details', ['slug' => $item->slug, 'id' => $item->service_id]) }}"
                                                                target="_blank" title="Remove"
                                                                class="btn btn-remove rounded-pill mx-auto">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            <a href="{{ route('remove.wishlist', ['id' => $item->service_id]) }}"
                                                                target="_self" title="Remove"
                                                                class="btn btn-remove rounded-pill mx-auto">

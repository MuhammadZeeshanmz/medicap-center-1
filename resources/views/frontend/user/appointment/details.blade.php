                                        ...
                                        @if (!is_null($appointment->invoice))
                                            <div class="col-lg-4">
                                                <div class="prinit mb-20">
                                                    <a href="{{ asset('assets/file/invoices/service/' . $appointment->invoice) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="main-info mb-30">
                                            ...
                                            <ul class="list">
                                                <li><span>{{ __('Name') . ':' }}</span>{{ $appointment->customer_name }}
                                                </li>
                                                <li><span>{{ __('Email') . ':' }}</span>{{ $appointment->customer_email }}
                                                </li>
                                                <li><span>{{ __('Phone') . ':' }}</span>{{ $appointment->customer_phone }}
                                                </li>
                                                <li><span>{{ __('Country') . ':' }}</span>
                                                    {{ $appointment->customer_country }}</li>
                                                <li><span>{{ __('Address') . ':' }}</span>
                                                    {{ $appointment->customer_address }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="main-info mb-30">
                                            ...
                                            <ul class="list">
                                                ...
                                                <li>
                                                    ...
                                                    <span
                                                        class="badge {{ $payment_bg }}">{{ __($appointment->payment_status) }}</span>
                                                </li>
                                                <li>
                                                    @php
                                                        if ($appointment->order_status == 'pending') {
                                                    ...
                                                    <span
                                                        class="badge {{ $order_bg }}">{{ __($appointment->order_status) }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="list">
                                                ...
                                                @if ($staff->info_status == 1)
                                                    @if ($staff->information)
                                                        <li>
                                                            <span
                                                                class="col-md-4">{{ __('Staff Information') . ': ' }}</span>
                                                            <p>

            ...
            <div class="row gx-xl-5">
                ...
                <div class="col-lg-8 col-xl-9">
                                ...
                                <div class="col-xl-4 col-sm-6" data-aos="fade-up">
                                    <div class="service-card featured border radius-md p-15 mb-25">
                                        ...
                                        <div class="service-details p-3">
                                            <div
                                                class="service-meta d-flex align-items-center justify-content-between gap-2">
                                            ...
                                            <h3 class="service-title">
                                                <a
                                                    href="{{ route('frontend.service.details', ['slug' => $service->slug, 'id' => $service->id]) }}">
                                                    ...
                                                    @if ($service->vendor->photo)
                                                        <a
                                                            ...
                                                            <img class="lazyload"
                                                                ...
                                                                alt="{{ $service->vendor->username }}" loading="lazy"
                                            ...
                                            <div
                                                class="service-footer d-flex align-items-center justify-content-between gap-2 mt-10">
                                                <div class="service-price">
                                                    <span class="current-price">{{ symbolPrice($service->price) }}</span>
                                                    @if ($service->prev_price)
                                                        <span
                                                            class="original-price">{{ symbolPrice($service->prev_price) }}</span>
                                                    @endif
                                                </div>
                                                <a href="javascript:void(0)" class="book-now-btn" data-bs-toggle="modal"
                    ...
                    <form id="searchForm" action="{{ route('frontend.services.category.search') }}" method="get">
                        ...
                        <input type="hidden" id="sort_val" name="sort_val"
                            value="{{ request()->input('sort_val') }}">

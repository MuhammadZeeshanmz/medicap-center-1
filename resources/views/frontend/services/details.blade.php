...
@section('content')
    ...
    <section class="page-header"
        @if (!empty($bgImg->breadcrumb)) style="background-image: url('{{ asset('assets/img/' . $bgImg->breadcrumb) }}')" @endif>
        <div class="container">
                  ...
                  <button class="gallery-next"><i class="fas fa-angle-right"></i></button>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="thumb-item">
                                                <img class="lazyload"
                                                    src="{{ asset('assets/frontend/images/placeholder.png') }}"
                                                    data-src="{{ asset('assets/img/services/service-gallery/' . $item->image) }}"
                                                    alt="Service thumbnail" loading="lazy">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="service-meta">
                                    <span class="service-category">
                                        <a
                                            href="{{ route('frontend.services', ['category_id' => $service->category->id]) }}">
                                            ...
                                            @if ($details->vendor->photo != null)
                                                <a
                                                    ...
                                                    <img class="lazyload"
                                                        ...
                                                        alt="{{ $details->vendor->username }}" loading="lazy"
                                        ...
                                        @else
                                            <a
                                                ...
                                                <img class="lazyload"
                                                    ...
                                                    alt="{{ $admin->username }}" loading="lazy" height="50px"
                                    ...
                                    <div class="provider-info">
                                        ...
                                        <div class="provider-rating">
                                            <div class="rating-stars">
                                                ...
                                                <div class="rating-foreground"
                                                    style="width: {{ $details->average_rating * 20 }}%"></div>
                                            </div>
                    ...
                    <div class="booking-cta">
                        <div class="cta-content">
                            ...
                            <button class="book-now-btn" data-bs-toggle="modal" data-bs-target="#makeBooking"
                                data-id="{{ $details->id }}">
                                {{ __('Book Now') }}
                            </button>
                        </div>
                    ...
                    <div class="service-reviews">
                        <div class="reviews-summary">
                            ...
                            <div class="average-rating">
                                <div class="rating-stars">
                                    <div class="rating-background"></div>
                                    <div class="rating-foreground" style="width: {{ $details->average_rating * 20 }}%">
                                    </div>
                                </div>
                        ...
                        <div class="rating-breakdown">
                            @foreach ([5, 4, 3, 2, 1] as $rating)
                                @php
                                    ...
                                    $percentage =
                                        $reviews->count() > 0 ? round(($ratingCount / $reviews->count()) * 100) : 0;
                                @endphp

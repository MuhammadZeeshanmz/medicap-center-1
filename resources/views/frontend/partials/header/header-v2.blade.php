        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="menu-dropdown">
                                        ...
                                        @foreach ($childMenusDatas as $childMenusData)
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="{{ $href }}">{{ $childMenusData->text }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                    ...
                    <header class="header-area header-2 @if (!request()->routeIs('index')) header-static @endif"
                        data-aos="fade-down">
                        <!-- Start mobile menu -->
                        <div class="mobile-menu">
                            <div class="container">
                        ...
                        <div class="main-navbar">
                            <div class="container">
                                        ...
                                        <ul id="mainMenu" class="navbar-nav mobile-item mx-auto">
                                            @foreach ($menuDatas as $menuData)
                                                ...
                                                @if (!property_exists($menuData, 'children'))
                                                    <li class="nav-item">
                                                        <a href="{{ $href }}"
                                                            class="nav-link toggle">{{ $menuData->text }}</a>
                                                    </li>
                                                @else
                                                    <li class="nav-item">
                                                        <a href="{{ $href }}"
                                                            class="nav-link toggle">{{ $menuData->text }}<i
                                                                class="fas fa-plus"></i></a>
                                                        <ul class="menu-dropdown">
                                                            @php $childMenusDatas = $menuData->children @endphp
                                                            @foreach ($childMenusDatas as $childMenusData)
                                ...
                                <header
                                    class="header-area header-2 @if (!request()->routeIs('index')) header-static @endif"
                                    data-aos="fade-down">
                                    <!-- Start mobile menu -->
                                    <div class="mobile-menu">
                                        <div class="container">

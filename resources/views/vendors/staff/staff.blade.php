                                        ...
                                        <div class="col-lg-4 mb-4">
                                            <div class="d-flex align-items-center gap-10">
                                                <label for="inputField"
                                                    class="flex-auto">{{ __('Staff Login Url') }}</label>
                                                <input type="text" readonly value="{{ route('staff.login') }}"
                                                    id="inputField" class="form-control">
                                                <span id="alert" class="text-bold">{{ __('Copied') }}</span>
                                                <button class="btn-sm btn-warning" id="cpyBtn"><i
                                            ...
                                            <tbody>
                                                @foreach ($staffs as $staff)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('assets/img/staff/' . $staff->image) }}"
                                                        ...
                                                        <td>
                                                            <form id="staffStatus{{ $staff->id }}"
                                                                class="d-inline-block"
                                                                action="{{ route('vendor.status.change') }}"
                                                                method="post">
                                                                @csrf
                                                                <select
                                                                    ...
                                                                    <option value="1"
                                                                        {{ $staff->status == 1 ? 'selected' : '' }}>
                                                                        {{ __('Active') }}
                                                                    </option>
                                                                    <option value="0"
                                                                        {{ $staff->status == 0 ? 'selected' : '' }}>
                                                                        {{ __('Deactive') }}
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <form class="staffDeleteForm"
                                                                        action="{{ route('vendor.staff_managment.delete', $staff->id) }}"
                                                                        method="post">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
                                                                            class="btn btn-sm px-3 deleteStaff">
                                                                            <span class="btn-label">

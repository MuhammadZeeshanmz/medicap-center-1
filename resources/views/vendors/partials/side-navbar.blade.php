@php $permission = App\Http\Helpers\VendorPermissionHelper::packagePermission(Auth::guard('vendor')->user()->id); @endphp
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li
                    class="nav-item @if (request()->routeIs('vendor.service_managment')) active @endif @if (request()->routeIs('vendor.service_managment.create')) active @endif @if (request()->routeIs('featured.service.online.success.page')) active @endif @if (request()->routeIs('featured.service.offline.success.page')) active @endif @if (request()->routeIs('vendor.service_managment.edit')) active @endif">
                    ...
                    <div id="services"
                        class="collapse @if (request()->routeIs('vendor.service_managment')) show @endif @if (request()->routeIs('vendor.service_managment.create')) show @endif @if (request()->routeIs('featured.service.online.success.page')) show @endif @if (request()->routeIs('featured.service.offline.success.page')) show @endif @if (request()->routeIs('vendor.service_managment.edit')) show @endif">
                        <ul class="nav nav-collapse">
                            <li
                                class="@if (request()->routeIs('vendor.service_managment')) active @elseif(request()->routeIs('featured.service.online.success.page')) active @elseif(request()->routeIs('featured.service.offline.success.page')) active @elseif (request()->routeIs('vendor.service_managment.edit')) active @endif">
                ...
                {{-- Staff managment --}}
                {{-- <li
                    class="nav-item @if (request()->routeIs('vendor.staff_managment')) active @endif @if (request()->routeIs('vendor.staff_managment.create')) active @endif @if (request()->routeIs('vendor.staff_managment.edit')) active @endif @if (request()->routeIs('vendor.staff_service_assign')) active @endif @if (request()->routeIs('vendor.staff.change_password')) active @endif @if (request()->routeIs('vendor.service.day')) active @endif @if (request()->routeIs('vendor.staff.permission')) active @endif @if (request()->routeIs('vendor.time-slot.manage')) active @endif> @if (request()->routeIs('vendor.staff.holiday.index'))
active
@endif">
                    ...
                    <div id="staff"
                        class="collapse @if (request()->routeIs('vendor.staff_managment')) show @endif @if (request()->routeIs('vendor.staff_managment.create')) show @endif @if (request()->routeIs('vendor.staff_managment.edit')) show @endif @if (request()->routeIs('vendor.staff.change_password')) show @endif @if (request()->routeIs('vendor.staff_service_assign')) show @endif @if (request()->routeIs('vendor.service.day')) show @endif @if (request()->routeIs('vendor.staff.permission')) show @endif @if (request()->routeIs('vendor.time-slot.manage')) show @endif> @if (request()->routeIs('vendor.staff.holiday.index'))
show
@endif">
                        <ul class="nav nav-collapse">
                            <li
...
@endif">
                ...
                {{-- Global Schedule --}}
                <li
                    class="nav-item @if (request()->routeIs('vendor.staff.global.day')) active @endif @if (request()->routeIs('vendor.global.holiday')) active @endif @if (request()->routeIs('vendor.global.time-slot.manage')) active @endif">
                    ...
                    <div id="time"
                        class="collapse @if (request()->routeIs('vendor.staff.global.day')) show @endif @if (request()->routeIs('vendor.global.holiday')) show @endif @if (request()->routeIs('vendor.global.time-slot.manage')) show @endif">
                        <ul class="nav nav-collapse">
                            <li
                                class="@if (request()->routeIs('vendor.staff.global.day')) active @endif @if (request()->routeIs('vendor.global.time-slot.manage')) active @endif">
                ...
                <li
                    ...
                    <div id="eventBooking"
                        class="collapse @if (request()->routeIs('vendor.pending_appointment')) show @endif @if (request()->routeIs('vendor.accepted_appointment')) show @endif @if (request()->routeIs('vendor.rejected_appointment')) show @endif @if (request()->routeIs('vendor.appointment.details')) show @endif @if (request()->routeIs('vendor.all_appointment')) show @endif">
                        <ul class="nav nav-collapse">
                            <li
                                class="@if (request()->routeIs('vendor.all_appointment')) active @endif @if (request()->routeIs('vendor.appointment.details')) active @endif">
                ...
                {{-- recipitent mail --}}
                <li class="nav-item @if (request()->routeIs('vendor.email.index')) active @endif">
                    <a href="{{ route('vendor.email.index') }}">
                        <i class="fas fa-envelope"></i>
                        <p>Recipient Mail</p>
                    </a>
                </li>
                {{-- plugin --}} @if ($permission != '[]')
                    @if ($permission->calendar_status == 1)
                        <li class="nav-item @if (request()->routeIs('vendor.plugins.index')) active @endif">
                ...
                --}} @if ($permission != '[]' && $permission->support_ticket_status == 1)
                            {{-- Support Ticket --}}
                            <li
                                class="nav-item @if (request()->routeIs('vendor.support_tickets')) active @elseif (request()->routeIs('vendor.support_tickets.message')) active @elseif (request()->routeIs('vendor.support_ticket.create')) active @endif">
                                ...
                                <div id="support_ticket"
                                    class="collapse @if (request()->routeIs('vendor.support_tickets')) show @elseif (request()->routeIs('vendor.support_tickets.message')) show @elseif (request()->routeIs('vendor.support_ticket.create')) show @endif">
                                    <ul class="nav nav-collapse">
                                        <li
                                            class="@if (request()->routeIs('vendor.support_tickets') && empty(request()->input('status'))) active @elseif(request()->routeIs('vendor.support_tickets.message')) active @endif">

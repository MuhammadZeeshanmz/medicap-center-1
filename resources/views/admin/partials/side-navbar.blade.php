...
active @endif
    ...
    {{-- website Pages --}}
    {{-- Pages --}}
    {{-- @if (is_null($roleInfo) || (!empty($rolePermissions) && array_intersect(['Home Page', 'About Us', 'FAQs', 'Blog', 'Contact Page', 'Additional Pages', 'Footer', 'Breadcrumbs', 'SEO Informations'], $rolePermissions)))
    <li
      class="nav-item
    ...
    {{-- @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Home Page', $rolePermissions)))
            <li class="submenu">
              ...
              <div id="home-page"
                class="collapse
                    @if (request()->routeIs('admin.home_page.section_content') || request()->routeIs('admin.home_page.about_section') || request()->routeIs('admin.home_page.banners') || request()->routeIs('admin.home_page.counter_section') || request()->routeIs('admin.home_page.product_section') || request()->routeIs('admin.home_page.section_customization') || request()->routeIs('admin.home_page.partners') || request()->routeIs('admin.shop_management.create_product') || request()->routeIs('admin.home.additional_sections') || request()->routeIs('admin.home.additional_section.edit') || request()->routeIs('admin.home.additional_section.create') || request()->routeIs('admin.shop_management.edit_product')) show @endif">
                <ul class="nav nav-collapse subnav">
    ...
    {{-- <li class="submenu">
                    ...
                    <div id="hoem-addi-section"
                      class="collapse
                    @if (request()->routeIs('admin.home.additional_sections') || request()->routeIs('admin.home.additional_section.create') || request()->routeIs('admin.home.additional_section.edit')) show @endif pl-3">
                      <ul class="nav nav-collapse subnav">
    ...
    {{-- @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('About Us', $rolePermissions)))
            <li class="submenu">
              ...
              <div id="about-page"
                class="collapse
                    @if (request()->routeIs('admin.about_us.index') || request()->routeIs('admin.about_us.customize') || request()->routeIs('admin.additional_sections') || request()->routeIs('admin.additional_section.create') || request()->routeIs('admin.additional_section.edit') || request()->routeIs('admin.about_us.testimonial_section')) show @endif">
                <ul class="nav nav-collapse subnav">
    ...
    {{-- <li class="submenu">
                    ...
                    <div id="addi-section"
                      class="collapse
                    @if (request()->routeIs('admin.additional_sections') || request()->routeIs('admin.additional_section.create') || request()->routeIs('admin.additional_section.edit')) show @endif pl-3">
                      <ul class="nav nav-collapse subnav">
    ...
    {{-- @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Blog', $rolePermissions)))
            <li class="submenu">
              ...
              <div id="blog-page"
                class="collapse
                    @if (request()->routeIs('admin.blog_management.categories') || request()->routeIs('admin.blog_management.create_blog') || request()->routeIs('admin.blog_management.edit_blog') || request()->routeIs('admin.blog_management.blogs')) show @endif">
                <ul class="nav nav-collapse subnav">
    ...
    {{-- @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('Additional Pages', $rolePermissions)))
            <li class="submenu">
              ...
              <div id="Additional-page"
                class="collapse
                    @if (request()->routeIs('admin.custom_pages') || request()->routeIs('admin.custom_pages.create_page') || request()->routeIs('admin.custom_pages.edit_page')) show @endif">
                <ul class="nav nav-collapse subnav">
                  <li

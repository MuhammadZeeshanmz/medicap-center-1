                            ...
                            @foreach ($blogs as $blog)
                                <div class="col-md-6 col-lg-4" data-aos="fade-up">
                                    <article class="card mb-25 shadow-md radius-md">
                                        ...
                                        <div class="card-content p-25">
                                            <ul class="card-list list-unstyled d-flex justify-content-between">
                                                <li class="mb-10 font-sm icon-start"><i
                                                        class="fas fa-user-circle"></i>{{ @$blog->author }}
                                                </li>
                                                <li class="mb-10 font-sm icon-start">
                                                    <a href="{{ route('blog', ['category' => $blog->categorySlug]) }}"
                                                        target="_self" title="{{ @$blog->categoryName }}"><i
                                                            class="fas fa-tag"></i>{{ @$blog->categoryName }}</a>
                                                </li>
                                                <li class="mb-10 font-sm icon-start"><i class="fas fa-calendar-alt"></i>
                                                    {{ \Carbon\Carbon::parse($blog->created_at)->format('F d, Y') }}
                                                </li>

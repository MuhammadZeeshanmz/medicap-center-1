                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <button class="nav-link active" type="button" data-bs-toggle="tab"
                                    data-bs-target="#default_tab" aria-selected="true">{{ __('All Services') }}</button>
                            </li>
                            @php
                                ...
                                <div class="row">
                                    @foreach ($services as $service)
                                        @php
                                            ...
                                            $feature = App\Models\FeaturedService\ServicePromotion::where(
                                                'order_status',
                                                '=',
                                                'approved',
                                            )
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="javaScript:void(0)"
                                                            ...
                                                            data-id="{{ $service->id }}" target="_self">
                                                            {{ __('Book Now') }}</a>
                                                    </div>
                                                </div>
                                            </div><!-- product-default -->
                    ...
                    <aside class="widget-area" data-aos="fade-up">
                        <div class="widget widget-author-details border p-25 radius-md mb-30">
                            ...
                            <ul class="toggle-list list-unstyled mt-20">
                                ...
                                @php
                                    $totalAppointment = App\Models\Services\ServiceBooking::where(
                                        'order_status',
                                        'completed',
                                    )

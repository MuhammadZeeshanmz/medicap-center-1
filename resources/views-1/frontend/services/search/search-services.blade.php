                    ...
                    <div class="product-details">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 mt-10">
                            ...
                            <a href="javaScript:void(0)" class="bookNowBtn btn btn-sm btn-outline-2"
                                data-bs-toggle="modal" data-id="{{ $service->id }}" data-bs-target="#makeBooking"
                                data-text="{{ request()->booking_date }}" title="Book Now" target="_self">
                                {{ __('Book Now') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="product-default border radius-md p-15 mb-25">
                    ...
                    <div class="product-details">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 mt-10">
                            ...
                            <a href="javaScript:void(0)" class="bookNowBtn btn btn-sm btn-outline-2"
                                data-bs-toggle="modal" data-id="{{ $service->id }}" data-bs-target="#makeBooking"
                                data-text="{{ request()->booking_date }}" title="{{ __('Book Now') }}"
                                target="_self">
                                {{ __('Book Now') }}</a>
                        </div>
                    </div>

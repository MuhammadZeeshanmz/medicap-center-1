                                    ...
                                    @foreach ($categories as $category)
                                        <li>
                                            ...
                                            <label class="form-radio-label"
                                                ...
                                                <span
                                                    class="qty">({{ $category->products()->get()->count() }})</span>
                                            </label>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="accordion-body scroll-y mt-20">
                                <ul class="list-group custom-radio">
                                    ...
                                    <li>
                                        ...
                                        <label class="form-radio-label"
                                            for="radioR-4"><span>{{ __('4 stars and higher') }}</span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <label class="form-radio-label"
                                            for="radioR-3"><span>{{ __('3 stars and higher') }}</span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <label class="form-radio-label"
                                            for="radioR-2"><span>{{ __('2 stars and higher') }}</span>
                                        </label>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <label class="form-radio-label"
                                            for="radioR-1"><span>{{ __('1 star and higher') }}</span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
